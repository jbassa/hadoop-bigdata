...
.execute program using preferable method i.e hadoop jar MapReduceSolution.jar project.ibm.ShowsOnAbcCount /ibm/data/genchan/ /ibm/data/output
*/

public class ShowsOnAbcCount {
	...
	public static void main(String[] args) throws URISyntaxException, IOException, InterruptedException, ClassNotFoundException {
		...
		Job job = new Job(conf, "viewers_ABC_Count");
	    job.setJarByClass( ShowsOnAbcCount.class );
